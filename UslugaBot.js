...
const countries = [
  ...
  'United Kingdom', 'UK', 'Великобритания', 'Англия', 'England',
...
Для того чтобы открыть меню для работы с ботом необходимо нажать на кнопку квадрата с четырься точками расположенную в строке "Сообщение".

1. \`/start\` — Начало работы с ботом, запуск клавиатуры для работы с ботом.
2. \`Ищу услугу\` — Позволяет создать заявку о поиске услуги в выбранной стране и городе.
3. \`Предоставляю услугу\` — Позволяет создать заявку о предоставлении услуги в выбранной стране и городе.
4. \`Мои заявки\` — Показывает ваши активные заявки.
5. \`/help\` — Показывает это сообщение.
